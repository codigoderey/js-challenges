...
```js
nameSet; // Set { 'John', 'Jane', 'Joe', 'Jack', 'Jill' }
```
...
```js
nameSet; // Set { 'John', 'Jane', 'Joe', 'Jill' }
```
...
```js
nameSet.values(); // [Set Iterator] { 'John', 'Jane', 'Joe', 'Jill' }
```
